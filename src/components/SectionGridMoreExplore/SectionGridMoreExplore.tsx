...
//     name: "Backpack",
//     desc: "Manufacturar",
//     image: "images/collections/explore1.png",
//     svgBg: "images/collections/explore1.svg",
//     color: "bg-indigo-50",
//   },
//   {
//     id: 2,
//     name: "Shoes",
//     desc: "Manufacturar",
//     image: "images/collections/explore2.png",
//     svgBg: "images/collections/explore2.svg",
...
//     desc: "Manufacturar",
//     image: "images/collections/explore3.png",
//     svgBg: "images/collections/explore3.svg",
//     color: "bg-violet-50",
//   },
//   {
//     id: 4,
//     name: "Cycling Shorts",
//     desc: "Manufacturar",
//     image: "images/collections/explore9.png",
//     svgBg: "images/collections/explore9.svg",
//     color: "bg-orange-50",
//   },
//   {
//     id: 5,
//     name: "Cycling Jersey",
//     desc: "Manufacturar",
//     image: "images/collections/explore5.png",
//     svgBg: "images/collections/explore5.svg",
//     color: "bg-blue-50",
//   },
//   {
//     id: 6,
//     name: "Car Coat",
//     desc: "Manufacturar",
//     image: "images/collections/explore6.png",
//     svgBg: "images/collections/explore6.svg",
//     color: "bg-orange-50",
//   },
//   {
//     id: 7,
//     name: "Sunglasses",
//     desc: "Manufacturar",
//     image: "images/collections/explore7.png",
//     svgBg: "images/collections/explore7.svg",
//     color: "bg-stone-100",
//   },
//   {
//     id: 8,
//     name: "kid hats",
//     desc: "Manufacturar",
//     image: "images/collections/explore8.png",
//     svgBg: "images/collections/explore8.svg",
//     color: "bg-blue-50",
//   },
//   {
//     id: 9,
//     name: "Wool Jacket",
//     desc: "Manufacturar",
//     image: "images/collections/explore4.png",
//     svgBg: "images/collections/explore4.svg",
//     color: "bg-slate-100/80",
//   },
// ];
...
const SectionGridMoreExplore: FC<SectionGridMoreExploreProps> = ({
  ...
  const [tabActive, setTabActive] = useState(data ? data[0].name : "");
        ...
        >
          {data &&
            data.map((collection, index) => (
              <NavItem2
                key={index}
                isActive={tabActive === collection.name}
                onClick={() => setTabActive(collection.name)}
              >
                <div className="flex items-center justify-center space-x-1.5 sm:space-x-2.5 text-xs sm:text-sm ">
                  <span
                    className="inline-block"
                    dangerouslySetInnerHTML={{
                      __html: `<svg class="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.1801 18C19.5801 18 20.1801 16.65 20.1801 15V9C20.1801 7.35 19.5801 6 17.1801 6C14.7801 6 14.1801 7.35 14.1801 9V15C14.1801 16.65 14.7801 18 17.1801 18Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M6.81995 18C4.41995 18 3.81995 16.65 3.81995 15V9C3.81995 7.35 4.41995 6 6.81995 6C9.21995 6 9.81995 7.35 9.81995 9V15C9.81995 16.65 9.21995 18 6.81995 18Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M9.81995 12H14.1799" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M22.5 14.5V9.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
